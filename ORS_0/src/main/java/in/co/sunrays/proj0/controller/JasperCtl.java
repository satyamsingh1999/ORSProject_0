...
public class JasperCtl {
	...
	public void display(HttpServletRequest request, HttpServletResponse response) throws JRException, SQLException, IOException {
		...
		String path = context.getRealPath("F:\\ORS_0\\src\\main\\webapp\\WEB-INF\\Blank_A4.jrxml");
		System.out.println("in jasper");
		Connection con = null;
		JasperReport jasperReport = JasperCompileManager.compileReport("F:\\ORS_0\\src\\main\\webapp\\WEB-INF\\Blank_A4.jrxml");
